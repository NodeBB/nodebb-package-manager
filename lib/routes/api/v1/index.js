...
module.exports = function(app, controllers) {
	...
	app.get(VERSION + 'plugins/:scope?/:package', middleware.recordIP, middleware.ensureValidPackage, controllers.plugins.get);
	app.put(VERSION + 'plugins/:scope?/:package', middleware.recordIP, controllers.plugins.update);
